        ...
        <form class="form" method="post" action="<?php echo e(route('login')); ?>">
            ...
            <div class="card card-login card-white">
                <div class="card-header">
                    ...
                    <h1 class="card-title">Yuk Login</h1>
                </div>
                <div class="card-body">
                    ...
                    <div class="input-group<?php echo e($errors->has('password') ? ' has-danger' : ''); ?>">
                        ...
                        <input type="password" placeholder="Password" name="password" class="form-control<?php echo e($errors->has('password') ? ' is-invalid' : ''); ?>">
                ...
                <div class="card-footer">
                    ...
                    <div class="pull-left">
                        <h6>
                            <a href="<?php echo e(route('register')); ?>" class="link footer-link">Belum punya akun? Buat akun yukk</a>
                        </h6>
                    </div>
...
<?php echo $__env->make('layouts.app', ['class' => 'login-page', 'page' => 'Laravel Inventory', 'contentClass' => 'login-page', 'section' => 'auth'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project najahah\laravel-inventory\resources\views/auth/login.blade.php ENDPATH**/ ?>