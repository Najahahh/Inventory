                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('clients.show', $client)); ?>" class="btn btn-sm btn-primary">Back to Client</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('transactions.store')); ?>" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group<?php echo e($errors->has('type') ? ' has-danger' : ''); ?>">
                                    ...
                                    <select name="type" id="input-method" class="form-control form-control-alternative<?php echo e($errors->has('type') ? ' is-invalid' : ''); ?>" required>
                                        <?php $__currentLoopData = ['income' => 'Payment Received', 'expense' => 'Returned Paid']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <?php if($type == old('type')): ?>
                                                <option value="<?php echo e($type); ?>" selected><?php echo e($title); ?></option>
                                            <?php else: ?>
                                ...
                                <div class="form-group<?php echo e($errors->has('amount') ? ' has-danger' : ''); ?>">
                                    ...
                                    <input type="number" step=".01" name="amount" id="input-amount" class="form-control form-control-alternative" placeholder="Amount" value="<?php echo e(old('amount')); ?>" required>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['page' => 'New Transaction', 'pageSlug' => 'clients', 'section' => 'transactions'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project najahah\laravel-inventory\resources\views/clients/transactions/add.blade.php ENDPATH**/ ?>