                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <label class="btn btn-sm btn-primary btn-simple" id="2">
                                ...
                                <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Klien</span>
                                <span class="d-block d-sm-none">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-sm btn-primary">Penjualan Baru</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('transactions.create', ['type' => 'expense'])); ?>" class="btn btn-sm btn-primary">Pengeluaran</a>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboard', 'page' => 'Dashboard', 'section' => ''], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project najahah\laravel-inventory\resources\views/dashboard.blade.php ENDPATH**/ ?>