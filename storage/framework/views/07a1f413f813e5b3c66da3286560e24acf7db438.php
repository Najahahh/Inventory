                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('transactions.type', ['type' => 'income'])); ?>" class="btn btn-sm btn-primary">Back to List</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', ['page' => 'New Income', 'pageSlug' => 'incomes', 'section' => 'transactions'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project najahah\laravel-inventory\resources\views/transactions/income/create.blade.php ENDPATH**/ ?>