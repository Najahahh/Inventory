                ...
                <div class="card-body">
                    <p class="card-text">
                        <div class="author">
                            ...
                            <a href="#">
                                <img class="avatar" src="<?php echo e(asset('assets/img/yaya.jpeg')); ?>" alt="">
...
<?php echo $__env->make('layouts.app', ['page' => __('User Profile'), 'pageSlug' => 'profile', 'section' => 'users'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\project najahah\laravel-inventory\resources\views/profile/edit.blade.php ENDPATH**/ ?>